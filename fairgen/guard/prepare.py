...
train_raw_data_list=[]
import json
with open("/home/DC/zenghang/vedio_safety/CIC/train_data.json", 'r') as f:  
    x = json.load(f)  

train_raw_data_list=[i['prompt'] for i in x]

import json
with open("/home/DC/zenghang/vedio_safety/CIC/LatentGuard/test.json", 'r') as f:  
    x = json.load(f)  

test_raw_data_list=[i['prompt'] for i in x]
